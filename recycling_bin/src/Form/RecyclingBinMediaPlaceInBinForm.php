...
/**
 * Place in bin form for media in the recycling bin module.
 */
class RecyclingBinMediaPlaceInBinForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $media = NULL) {
    $form['description'] = [
      '#type' => 'item',
      '#markup' => $this->t('Are you sure you want to place media: ' . $media->label() . ' in the recycling bin?'),
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $media = $form_state->getTriggeringElement()['#media'];
    $message = 'Media: ' . $media->label() . ' has been added to the recycling bin.';
    $media->set('in_recycle', TRUE);
