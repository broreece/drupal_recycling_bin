...
/**
 * Deletion form for nodes in the recycling bin module.
 */
class RecyclingBinNodeConfirmDeletionForm extends FormBase {
  ...
  public function getFormId() {
    return 'recycling_bin.node.confirm_delete_form';
  }

  public function buildForm(array $form, FormStateInterface $form_state, $node = NULL) {
    $form['description'] = [
      '#type' => 'item',
      '#markup' => $this->t('Are you sure you want to delete node: ' . $node->label() . ' from the recycling bin?'),
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $message = 'Node: ' . $node->label() . ' has been manually removed from the recycling bin.';
    $node->delete();
