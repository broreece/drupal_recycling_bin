...
/**
 * Check if a node is currently in the recycling bin.
 */
class GeneralAccessCheck implements AccessInterface {
  ...
  /**
   * Checks if current node is in the recycling bin, if so returns access denied.
   */
  public function access() {
    ...
    if ($entity != NULL) {
      ...
      if ($entity->access('view', $this->currentUser->getAccount())) {
